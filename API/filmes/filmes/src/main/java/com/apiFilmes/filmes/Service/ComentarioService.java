...
import com.apiFilmes.filmes.Repository.ComentarioRepository;
...
public class ComentarioService {
	...
	public Comentario  atualizar(Comentario  comentario, Long id) {
		Comentario comentarioPresente = comentarioRepository.findById(id).orElseThrow(() -> new RuntimeException("dados não encontrado com o id" + id));
