...
import com.apiFilmes.filmes.Service.ComentarioService;
...
public class ComentarioController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Comentario> atualizarComentario(@Valid @RequestBody Comentario comentario, @PathVariable Long id){
